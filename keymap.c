...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    case QMKMAIL:
        if (record->event.pressed) {
            // when keycode QMKMAIL is pressed
            SEND_STRING("Hallo yusammen,\n\n\n\nBeste Gr" SS_TAP(X_LBRC) SS_TAP(X_MINS) "e" SS_TAP(X_UP) SS_TAP(X_UP));
        } else {
            // when keycode QMKMAIL is released
        }
        break;
    }
    return true;
 ...
 * `-------------------------------------------|       /     \      \-----------------------------------------------'
 *                 | LALT| LGUI | LCTL |LOWER| Space /       \Enter \  |RAISE |BackSP| RGUI | RALT |
 *                 `----------------------------------'       '------------------------------------'
 */
 ...
 [_QWERTZ] = LAYOUT(
    ...
    KC_LCTL, KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,    QMKMAIL,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, RSFT_T(KC_ENT),
                      KC_LALT, KC_LGUI, KC_LCTL, LOWER,   KC_SPC,   KC_ENT,   RAISE,   KC_BSPC, KC_RGUI, KC_RALT
),
/* LOWER
 * ,-------------------------------------------.                    ,-----------------------------------------.
 ...
 * |        |      |      |      |      |      |-------|    |-------|      |   _  |   +  |   {  |   }  |   \  |
 * `-------------------------------------------|       /     \      \-----------------------------------------------'
 *                 | LALT| LGUI | LCTRL |LOWER| Space /       \Enter \  |RAISE |BackSP| RGUI | RALT |
 *                 `----------------------------------'       '------------------------------------'
 */
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    [_QWERTZ] =   { ENCODER_CCW_CW(KC_UP, KC_DOWN), ENCODER_CCW_CW(KC_RGHT, KC_LEFT)  },
